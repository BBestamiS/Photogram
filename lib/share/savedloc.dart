...
import 'package:photogram/share/savedlocimage.dart';
...
class _FindState extends State<SavedLoc> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> _locsStream = _firestore
  ...
  Future selectFile(locSelected) async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SavedLocImage(locSelected, File(path)),
      ),
    );
  }
